...
// func GetTicketByMovieIdAndDateDay(movie_id, date_day string) (*models.TickRetss, error) {
	
// 	id := utils.ShiftToNum64(movie_id)
	
// 	str_day  := strings.Split(date_day, "-")
// 	day := utils.ShiftToNum(str_day[0])*10000 + utils.ShiftToNum(str_day[1])*100 + utils.ShiftToNum(str_day[2]) 

	
// 	p1, err := mysql.GetTicketByMovieIdAndDateDay(id, int64(day))
// 	if err != nil {
// 		return nil, err
// 	}
...
// 	p1, err := mysql.GetTicketByCinemaIdAndDateDay(id, int64(day))
